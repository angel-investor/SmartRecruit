...
class Config(BaseModel):
    ...
    # MongoDB 配置
    # MONGO_HOST: str = Field(default="81.69.42.210", description="MongoDB 主机")
    MONGO_HOST: str = Field(default="127.0.0.1", description="MongoDB 主机")
    ...
    # Milvus 配置
    # MILVUS_HOST: str = Field(default="81.69.42.210", description="Milvus 主机")
    ...
    # Elasticsearch 配置
    # ES_HOST: str = Field(default="http://81.69.42.210:9200", description="ES 主机")
    ES_HOST: str = Field(default="http://127.0.0.1:9200", description="ES 主机")
    ES_INDEX_NAME: str = Field(default="resume_chunks", description="ES 索引名")

    # 模型路径
    MODEL_PATH: str = Field(default=r"D:\project\SmartRecruit\models", description="本地模型路径")
    EMBEDDING_MODEL: str = Field(default=r"D:\project\SmartRecruit\models\bge-m3",
                                 description="嵌入模型")
    RERANKER_MODEL: str = Field(default=r"D:\project\SmartRecruit\models\bge-reranker-base",
                                description="重排序模型")

    # API 密钥
    DASHSCOPE_API_KEY: str = Field(default="your_dashscope_api", description="DashScope API 密钥")

    # 本地简历路径
    LOCAL_RESUME_DIR: str = Field(default=r"D:\project\SmartRecruit\data\resume",
                                  description="本地简历目录")
