...
class Config(BaseModel):
    ...
    # 模型路径
    MODEL_PATH: str = Field(default="D:\\project\\app_new\\models", description="本地模型路径")
    EMBEDDING_MODEL: str = Field(default=r"D:\project\SmartRecruit\models\bge-m3", description="嵌入模型")
    RERANKER_MODEL: str = Field(default=r"D:\project\SmartRecruit\models\bge-m3", description="重排序模型")
