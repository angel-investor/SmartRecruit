...
test_file_path = os.path.join(r"D:\project\SmartRecruit\data\resume\林青霞_test.txt")
# 初始化客户端
client = OpenAI(api_key="your_dashscope_api", base_url="https://dashscope.aliyuncs.com/compatible-mode/v1")
