...
# 添加项目根目录到Python路径
import os,sys
current_dir = os.path.dirname(os.path.abspath(__file__))  # eval目录
smartrecruit_dir = os.path.dirname(current_dir)  # SmartRecruit目录
project_root = os.path.dirname(smartrecruit_dir)  # Chapter3_RAG根目录

sys.path.insert(0, project_root)
sys.path.insert(0, smartrecruit_dir)

print(f"添加路径: {project_root}")
print(f"添加路径: {smartrecruit_dir}")
# --- 步骤 1: 导入所需库与模块 ---
